...
# Display logo
st.markdown("<div style='text-align: center;'><img src='groundswell_logo.jpg' width='300'></div>", unsafe_allow_html=True)
st.markdown("<h1 style='text-align: center; color: white; background-color: black; padding: 10px;'>Groundswell Dance Company</h1>", unsafe_allow_html=True)
...
# --- Main App (Logged In) ---
    ...
    if is_teacher:
        ...
        for student, s_goals in st.session_state.user_goals.items():
        ...
        my_templates = [t for t in st.session_state.templates if any(g in my_groups for g in t.get("groups", []))]
