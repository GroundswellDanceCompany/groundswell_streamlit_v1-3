...
toggle = st.radio("", ["Login", "Create Account"], horizontal=True)
st.session_state.register = toggle == "Create Account"

if st.session_state.register:
    st.title("Create Student Account")
    new_user = st.text_input("Choose a username")
    new_pass = st.text_input("Choose a password", type="password")
    new_class = st.selectbox("Select your class group", CLASS_GROUPS)
